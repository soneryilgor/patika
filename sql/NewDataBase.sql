...
--Oluşturduğumuz employee tablosuna 'Mockaroo' servisini kullanarak 50 adet veri ekleyelim.    
    insert into employee (id, name, email, birthday) values (1, 'Hester Farguhar,5/14/2001,hfarguhar0@mapy.cz');
    insert into employee (id, name, email, birthday) values (2, 'Nelle Ledford,3/26/2001,nledford2@unicef.org');
    insert into employee (id, name, email, birthday) values (3, 'Artemus', 'acharrett2@barnesandnoble.com', '2022-09-17');
    insert into employee (id, name, email, birthday) values (4, 'Krystalle Rawsen,9/23/2003,krawsen3@baidu.com');
    insert into employee (id, name, email, birthday) values (5, 'Batsheva', 'bbather4@webs.com', '1969-01-14');
    insert into employee (id, name, email, birthday) values (6, 'Lilian Brownsword,9/6/2004,lbrownsword5@facebook.com');
    insert into employee (id, name, email, birthday) values (7, 'Claudetta', 'cskett6@freewebs.com', '2012-10-16');
    insert into employee (id, name, email, birthday) values (8, 'Crysta Casillas,4/12/2000,ccasillas7@mapy.cz');
    ...
    UPDATE employee SET name='Soner Yılgör', email='soneryilgor@gmail.com', birthday='2000-01-01' WHERE id='1';
    UPDATE employee SET name='Burhan' WHERE id='2';
    UPDATE employee SET email='Yeni Isim' WHERE name ILIKE'a%';
    UPDATE employee SET birthday='2002-07-11' WHERE id='10';
    UPDATE employee SET name='Degistir' WHERE email ILIKE('B%');
